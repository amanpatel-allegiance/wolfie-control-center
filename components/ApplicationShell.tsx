    ...
    <div className="min-h-screen">
      ...
      <div className="min-w-0 lg:pl-[232px]">
        <header className="sticky top-0 z-30 flex h-[58px] items-center gap-4 border-b border-white/10 bg-wolfie-navy px-4 lg:border-wolfie-border lg:bg-white lg:px-6">
          ...
          <span className="hidden h-9 items-center gap-1.5 rounded-lg border border-wolfie-border bg-white px-3 text-[13px] font-semibold text-[#344054] sm:inline-flex"><Clock3 className="size-3.5 text-wolfie-muted" />GST (UTC+4)⌄</span>
